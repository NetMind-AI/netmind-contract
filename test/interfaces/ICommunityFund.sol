...
interface ICommunityFund {
    ...
    function queryProposalMsg( bool _type,uint256 _page,uint256 _limit ) external view returns (address[] memory , string[] memory , address[] memory , uint256[] memory , bool[] memory , uint256[] memory , address[] memory , uint256[] memory , uint256 ) ;
