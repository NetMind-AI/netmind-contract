...
contract Conf is Initialize {
    ...
    function awardDetals() public view returns (uint256 miner, uint256 node, uint256 lp, uint256 staking){
        ...
        else if (block.timestamp < phase_2 )return (27397_260270e12, 5479_452055e12/10, 5479_452055e12 *4/10, 5479_452055e12/2);  //phase_1
        else if (block.timestamp < phase_3 )return (20547_945210e12, 4794_520548e12/10, 4794_520548e12 *4/10, 4794_520548e12/2);  //phase_2
        else if (block.timestamp < phase_4 )return (13698_630140e12, 4109_589041e12/10, 4109_589041e12 *4/10, 4109_589041e12/2);  //phase_3
        else if (block.timestamp < phase_5 )return (10273_972600e12, 4109_589041e12/10, 4109_589041e12 *4/10, 4109_589041e12/2);  //phase_4
        else                                return ( 6849_315068e12, 4109_589041e12/10, 4109_589041e12 *4/10, 4109_589041e12/2);  //phase_5
    }
